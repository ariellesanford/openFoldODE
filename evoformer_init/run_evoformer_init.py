    ...
    for model, output_directory in model_generator:
        ...
        for (tag, tags), seqs in sorted_targets:
            ...
            if os.path.exists(unrelaxed_output_path):
                logger.info(f"✅ Output already exists for {tag} — skipping inference.")
                continue
            ...
            try:
                ...
                save_dir = os.path.join(args.output_dir, f"{tag}_evoformer_blocks") if args.save_intermediates else None

                out = run_model(model, processed_feature_dict, tag, args.output_dir,
                                save_intermediates=args.save_intermediates, save_dir=save_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--save_intermediates", action="store_true", default=False,
        help="If set, Evoformer intermediates will be saved per recycling step."
    )

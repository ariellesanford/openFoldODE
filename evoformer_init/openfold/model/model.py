...
class AlphaFold(nn.Module):
    ...
    def iteration(self, feats, prevs, _recycle=True, recycle_step=None, save_intermediates_dir=None):
        ...
        if self.globals.offload_inference:
            ...
            m, z, s = self.evoformer(
                ...
                inplace_safe=inplace_safe,
                _mask_trans=self.config._mask_trans,
                recycle_step=recycle_step,
                save_dir=save_intermediates_dir,
            )
        ...
        print("✅ Stopping before structure module and final atom prediction.")

        return outputs, None, None, None, True  # Skip rest of pipeline
        ...
        for cycle_no in range(num_iters):
            ...
            with torch.set_grad_enabled(is_grad_enabled and is_final_iter):
                ...
                outputs, m_1_prev, z_prev, x_prev, early_stop = self.iteration(
                    ...
                    recycle_step=cycle_no,
                    save_intermediates_dir = kwargs.get("save_intermediates_dir", None)
                )

...
BASE_DIR="/home/visitor/PycharmProjects/openFold/checkpointing/RODA"
...
echo "🌐 Downloading mmCIFs from RCSB PDB..."
...
for pdbid in "${NORMALIZED_IDS[@]}"; do
    ...
    curl -s -f "$cif_url" -o "$output_path" || echo "⚠️  Failed to download $pdbid from RCSB"
done

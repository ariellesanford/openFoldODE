...
EVOFORMER_OUTPUTS_DIR="${DATA_DIR}/post_evoformer_predictions/predictions_20250605_183403/${PDB_ID}"  # Neural ODE outputs
MSA_PATH="${EVOFORMER_OUTPUTS_DIR}/msa_representation.pt"
PAIR_PATH="${EVOFORMER_OUTPUTS_DIR}/pair_representation.pt"
OUTPUT_DIR="${DATA_DIR}/structure_predictions/${PDB_ID}/neuralODE" # Where to save structures

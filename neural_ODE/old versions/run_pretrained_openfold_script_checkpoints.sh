...
OUTPUT_DIR="${DATA_DIR}/structure_predictions/${PDB_ID}/openfold_0recycles"
...
#TEMPLATE_MMCIF_DIR="${DATA_DIR}/template_data/pdb70_mmcif/mmcif_files"
#OUTPUT_DIR="${DATA_DIR}/predictions/${PDB_ID}/from_save_intermediates"
...
cd /home/visitor/PycharmProjects/openFold/structure_module  #save_intermediates/
